        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch mb-28">
            {plans.map((plan, index) => {
              const variants: Array<'slideRight' | 'fadeUp' | 'slideLeft'> = ['slideRight', 'fadeUp', 'slideLeft'];
              return (
                <ScrollAnimate key={plan.id} variant={variants[index % 3]} delay={index * 0.1}>
                  <div
                    className={`p-8 rounded-3xl border flex flex-col justify-between relative overflow-hidden h-full ${
                      plan.isPopular
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="h-[1px] bg-white/5 my-6" aria-hidden="true" />
                    ...
                    <a
                      ...
                      className={`w-full py-3.5 text-center text-xs font-bold rounded-xl transition-all block ${
                        plan.isPopular
          ...
          <div className="border-t border-white/5 pt-20">
            ...
            <ScrollAnimate variant="scaleIn" delay={0.15}>
